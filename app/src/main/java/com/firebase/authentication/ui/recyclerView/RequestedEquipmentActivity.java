...
import com.firebase.authentication.ui.adapters.ReceivedRequestAdapter;
...
public class RequestedEquipmentActivity extends AppCompatActivity {

    RecyclerView recyclerView;
    Query display_equipment_ref;
    ReceivedRequestAdapter requestAdapter;

    @Override
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(RequestedEquipmentActivity.this, EquipmentOwnerDashboard.class));
        finish();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_requested_equipment);
        ...
        FirebaseRecyclerOptions<Equipment> options = new FirebaseRecyclerOptions.Builder<Equipment>()
                ...
                .build();
        requestAdapter = new ReceivedRequestAdapter(options);
